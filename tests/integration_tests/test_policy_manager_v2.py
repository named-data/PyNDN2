...
TEST_RSA_PUBLIC_KEY_DER = bytearray([
...
TEST_RSA_PRIVATE_KEY_PKCS8 = bytearray([
...
CERT_DUMP="Bv0BnwcxCAR0ZW1wCANLRVkIEWtzay0xNDE0MTk1Nzc5NjY1CAdJRC1DRVJUCAgA\
...
def doVerify(policyManager, toVerify):
    success = Mock()
    failure = Mock()
    result = policyManager.checkVerificationPolicy(toVerify, 0, success, failure)
