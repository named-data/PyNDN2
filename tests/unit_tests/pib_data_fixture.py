...
# Aauthor: From ndn-group-encrypt unit tests
...
class PibDataFixture(object):
    ...
    def __init__(self):
        ...
        self.id1Key1Name = self.id1Key1Cert1.getKeyName()
        self.id1Key2Name = self.id1Key2Cert1.getKeyName()

        self.id2Key1Name = self.id2Key1Cert1.getKeyName()
        self.id2Key2Name = self.id2Key2Cert1.getKeyName()

        self.id1Key1 = self.id1Key1Cert1.getPublicKey()
        self.id1Key2 = self.id1Key2Cert1.getPublicKey()
        self.id2Key1 = self.id2Key1Cert1.getPublicKey()
        self.id2Key2 = self.id2Key2Cert1.getPublicKey()
