...
"""
This module defines the HmacWithSha256Signature which extends Signature and
holds the signature bits and other info representing an HmacWithSha256 signature
in a packet.
"""
...
class HmacWithSha256Signature(Signature):
    """
    ...
    def __init__(self, value = None):
        if value == None:
            ...
            raise RuntimeError(
              "Unrecognized type for HmacWithSha256Signature constructor: " +
              str(type(value)))
    ...
    def clone(self):
        ...
        :rtype: HmacWithSha256Signature
        """
        return HmacWithSha256Signature(self)
