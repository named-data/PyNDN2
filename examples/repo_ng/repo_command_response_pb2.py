...
RepoCommandResponseMessage = _reflection.GeneratedProtocolMessageType('RepoCommandResponseMessage', (_message.Message,), dict(

  RepoCommandResponse = _reflection.GeneratedProtocolMessageType('RepoCommandResponse', (_message.Message,), dict(
    DESCRIPTOR = _REPOCOMMANDRESPONSEMESSAGE_REPOCOMMANDRESPONSE,
    __module__ = 'repo_command_response_pb2'
...
_sym_db.RegisterMessage(RepoCommandResponseMessage)
_sym_db.RegisterMessage(RepoCommandResponseMessage.RepoCommandResponse)
